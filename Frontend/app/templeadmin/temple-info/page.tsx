...
export default function TempleInfo() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const templeResponse = await fetch(
          "http://localhost:5500/api/v1/templeDetails/get-temple-by-admin",
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${accessToken}`,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5500/api/v1/templeDetails/create-temple",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${accessToken}`,
  ...
  const updateCoverImage = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5500/api/v1/templeDetails/update-cover-image/${templeData._id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${accessToken}`,
  ...
  const uploadGalleryImages = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5500/api/v1/templeDetails/add-gallery-images/${templeData._id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${accessToken}`,
  ...
  const deleteGalleryImage = async (imageUrl) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5500/api/v1/templeDetails/delete-gallery-image/${templeData._id}`,
        {
          method: "DELETE",
          headers: {
