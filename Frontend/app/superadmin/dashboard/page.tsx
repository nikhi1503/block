...
export default function SuperAdminDashboard() {
  ...
  useEffect(() => {
    const fetchUserCount = async () => {
      try {
        const userResponse = await fetch("http://localhost:5500/api/v1/superAdminDashboard/count-users", {
          method: "GET",
          headers: {
        ...
        const templeResponse = await fetch("http://localhost:5500/api/v1/superAdminDashboard/count-temple-admins", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
