...
useEffect(() => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await fetch("http://localhost:5500/api/v1/users/verify-email", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  try {
    const accessToken = sessionStorage.getItem("accessToken");
    const response = await fetch("http://localhost:5500/api/v1/users/store-wallet-address", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await fetch("http://localhost:5500/api/v1/users/resend-otp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
